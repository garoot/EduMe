...
urlpatterns = [
    ...
    url(r'^list_courses/(?P<type>\w+)/$', views.list_courses, name='list_courses_type'),
    ...
    url(r'^display_catalog/(?P<category_id>[0-9]+)/$', views.display_catalog, name='display_catalog_category'),
    url(r'^display_catalog/(?P<subcategory_id>[0-9]+)/$', views.display_catalog, name='display_catalog_subcategory'),
